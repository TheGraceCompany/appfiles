...
class MenuMiddleware
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        Menu::make('addons', function ($menu) {
            $menu->add('Accessories', getLang().'/add-ons');
            $menu->add('Luminess', getLang().'/add-ons/luminess');
        });
        ...
        Menu::make('qnique', function ($menu) {
            $menu->add('Qnique 21"', getLang().'/sewing-machines/qnique');
            $menu->add('Qnique 14"', getLang().'/sewing-machines/qnique/qnique14');
