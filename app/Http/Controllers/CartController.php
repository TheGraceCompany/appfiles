...
//            Cart::whereProduct_idAndUser_id($product_id,  $user_id = Sentinel::getUser()->getUserId()->delete());
    ...
    public function payment(Request $request) {
        ...
        try {
            ...
            $location = Location::updateOrCreate(array('id' => Input::get('billing_id')), $billing);
            ...
            $location = Location::updateOrCreate(array('id' => Input::get('shipping_id')), $shipping);
...
//            dd(round($total,2));
            $response = $client->Request('POST', 'https://pilot-payflowpro.paypal.com', ['form_params' =>
                ['PARTNER' => 'PayPal', 'PWD' => '6428joel', 'VENDOR' => 'suncrest1234', 'USER' => 'suncrest1234',
